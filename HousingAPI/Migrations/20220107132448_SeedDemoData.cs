    ...
    public partial class SeedDemoData : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"
                ...
                --Create User
                --------------------------
                IF not exists (select UserId from Users where Username='Demo')
                ...
                SET @UserID = (select UserId from Users where Username='Demo')
                ...
                --Seed Cities
                --------------------------
                IF not exists (select top 1 CityId from Cities)
                Insert into Cities(CityName,LastUpdatedBy,LastUpdatedOn,Country)
                ...
                (select PropertyTypeId from PropertyTypes where Name='Apartment'), --Property Type ID
                2, --BHK
                (select FurnishingTypeId from FurnishingTypes where Name='Fully'), --Furnishing Type ID
                1800, --Price
                1400, --Built Area
                900, --Carpet Area
                '6 Street', --Address
                'Golf Course Road', -- Address2
                (select top 1 CityId from Cities), -- City ID
                3, -- Floor No
                3, --Total Floors
                1, --Ready to Move
                'East', --Main Entrance
